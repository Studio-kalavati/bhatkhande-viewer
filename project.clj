(defproject studiokalavati/bhatkhande-viewer "0.1.4-SNAPSHOT"
  :dependencies [[org.clojure/clojure "1.10.0"]
                 ...
                 [reagent "0.8.1"]
                 [studiokalavati/sargam-spec "0.1.7"]
                 [reagent-utils "0.3.1"]
                 [re-frame "0.10.6"]
                 [quil "2.8.0"]
                 [re-com "2.5.0"]
  ...
  :repositories [["snapshots" "https://maven.pkg.github.com/Studio-kalavati/bhatkhande-viewer"]
               ["releases" "https://maven.pkg.github.com/Studio-kalavati/bhatkhande-viewer"]]
  :doo {:build "test"}
  :profiles
  {:dev
   {
